...
{{/*
Create the name of the Secret containing the TLS certificate.
Derived as "<plugin-name>-cert" unless overridden in values.
*/}}
...
{{/*
Create the name of the patcher resources
*/}}
